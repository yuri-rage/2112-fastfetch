...
# clone into ~/.config/fastfetch
git clone https://github.com/opalramen2112/2112-fastefetch.git ~/.config/fastfetch
```

## Usage

```bash
fastfetch # can be added to .bashrc, .fishrc, .zshrc, etc
```
